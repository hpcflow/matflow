...
def test_subset_sim_toy_model_two_level_external_parameter_flow(null_config, tmp_path):
...
@pytest.mark.integration
def test_subset_sim_DAMASK_Mg_two_level_parameter_flow(null_config, tmp_path):

.. MatFlow documentation master file, created by
   sphinx-quickstart on Wed Mar 16 10:54:48 2022.
...
It is designed to be flexible and extensible, allowing users to link together existing tools and run anlaysis pipelines.
It aims to support reproducible science by documenting workflows in the form of YAML files which can be shared and reused.

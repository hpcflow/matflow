.. jinja:: first_ctx
  ...
  .. code-block:: console
      ...
      {{ app_module }} demo-workflow copy modify_volume_element_grid_size .
  
  which we can then use to submit the workflow.
  
  .. code-block:: console
  
      {{ app_module }} go modify_volume_element_grid_size .yaml
  ...
  .. code-block:: console
      ...
      {{ app_module }} demo-workflow go modify_volume_element_grid_size
